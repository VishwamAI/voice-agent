 ...
 */
export declare type Expression = ActionExpression | BlockExpression | ConditionalBranch | ConfirmAction | DialogExpansion | End | Ensure | Expect | InvokeApi | Response | Start;
