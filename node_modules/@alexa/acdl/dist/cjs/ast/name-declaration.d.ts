...
export declare type NameDeclarationParent = Module | SampleScope | ConditionScope | InteractionScope | CorrectionScope;
/**
 ...
 */
export declare type Named = Call | NameReference | PropertyReference | Condition;
