...
export declare type ConditionParent = ConditionScope | SampleScope | NameDeclaration;
export declare type ConditionExpression = SampleExpression;
export declare type ConditionScope = ThenScope | ElseScope;
