 ...
 */
export declare type ArgumentValue = Call | NameReference | PropertyReference | undefined;
/**
 * Allowed values for the `Arguments` of a `Call`.
 */
export declare type Arguments = undefined | string | number | boolean | null | ListLiteral | Utterance | Argument[];
