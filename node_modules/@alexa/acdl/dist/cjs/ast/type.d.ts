...
export declare class TypeProperty extends Tree<"TypeProperty", TypeDeclaration> {
     ...
     * Annotations attached to this Type Property.
     */
    annotations?: Annotation<import("./annotation").AnnotatedNode>[] | undefined, loc?: SourceLocation | undefined);
    clone(): TypeProperty;
}
export declare const isTypeReference: (node: any) => node is TypeReference;
export declare type TypeReferenceParent = ActionDeclaration | ArgumentDeclaration | Call | DialogDeclaration | NameDeclaration | TypeDeclaration | TypeParameter | TypeProperty | TypeReference;
/**
...
export declare type TypeParameterParent = TypeReference | TypeDeclaration | ActionDeclaration | DialogDeclaration;
/**
