 ...
 */
export declare type Thing = ActionThing | ArgumentThing | ArgumentsThing | BooleanThing | DialogThing | FunctionThing | ListThing | NothingThing | NumberThing | ObjectThing | StringThing | AnyThing | VoidThing | UnionThing;
export declare type Primitive = BooleanThing | NumberThing | StringThing | NothingThing | VoidThing;
/**
 * Nodes that represent a distinct instance of some value.
 */
export declare type ThingNode = ask.NameDeclaration | ask.ActionDeclaration | ask.ArgumentDeclaration | ask.Block | ask.Call | ask.Condition | ask.DialogDeclaration | ask.EnumDeclaration | ask.EnumItem | ask.ResponseTemplate | ask.PropertyReference | ask.SlotType | ask.TypeDeclaration | ask.Utterance;
