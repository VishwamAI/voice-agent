...
import { Slot_valueContext } from "./ACDLParser";
import { VarContext } from "./ACDLParser";
...
export interface ACDLParserListener extends ParseTreeListener {
    ...
    /**
     * Enter a parse tree produced by `ACDLParser.slot_value`.
     * @param ctx the parse tree
     */
    enterSlot_value?: (ctx: Slot_valueContext) => void;
    /**
     * Exit a parse tree produced by `ACDLParser.slot_value`.
     * @param ctx the parse tree
     */
    exitSlot_value?: (ctx: Slot_valueContext) => void;
    /**
     * Enter a parse tree produced by `ACDLParser.var`.
     * @param ctx the parse tree
     */
    enterVar?: (ctx: VarContext) => void;
    /**
     * Exit a parse tree produced by `ACDLParser.var`.
     * @param ctx the parse tree
     */
