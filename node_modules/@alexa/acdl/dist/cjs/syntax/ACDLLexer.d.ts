...
export declare class ACDLLexer extends Lexer {
    ...
    static readonly IN_STRING = 1;
    static readonly IN_INTERPOLATION = 2;
    static readonly IN_SLOT_VALUE = 3;
...
//# sourceMappingURL=ACDLLexer.d.ts.map