...
export declare class ACDLParser extends Parser {
    ...
    static readonly IDENTIFIER = 48;
    static readonly ASTERISK = 49;
    static readonly STRING_START = 50;
    static readonly STRING_STOP = 51;
    static readonly INTERPOLATION_START = 52;
    static readonly STRING_CONTENT = 53;
    static readonly INCOMPLETE_STRING = 54;
    static readonly INTERPOLATION_END = 55;
    static readonly INCOMPLETE_INTERPOLATION = 56;
    static readonly SLOT_VALUE_CONTENT = 57;
    static readonly INCOMPLETE_SLOT = 58;
    static readonly RULE_line = 0;
    static readonly RULE_singleLineExpr = 1;
    static readonly RULE_module = 2;
    static readonly RULE_moduleExpression = 3;
    static readonly RULE_keyword = 4;
    static readonly RULE_identifier = 5;
    static readonly RULE_qualifiedName = 6;
    static readonly RULE_namespaceDeclaration = 7;
    static readonly RULE_importDeclaration = 8;
    static readonly RULE_enumDeclaration = 9;
    static readonly RULE_enumItem = 10;
    static readonly RULE_typeReference = 11;
    static readonly RULE_typeArguments = 12;
    static readonly RULE_typeDeclaration = 13;
    static readonly RULE_typeArgumentDeclarations = 14;
    static readonly RULE_typeArgumentDeclaration = 15;
    static readonly RULE_typeConstraint = 16;
    static readonly RULE_typeProperties = 17;
    static readonly RULE_typeProperty = 18;
    static readonly RULE_argumentDeclarations = 19;
    static readonly RULE_argumentDeclaration = 20;
    static readonly RULE_standardArgumentDeclaration = 21;
    static readonly RULE_functionArgumentDeclaration = 22;
    static readonly RULE_argumentDefault = 23;
    static readonly RULE_actionDeclaration = 24;
    static readonly RULE_interactionDeclaration = 25;
    static readonly RULE_dialogDeclaration = 26;
    static readonly RULE_dialogScope = 27;
    static readonly RULE_functionSignature = 28;
    static readonly RULE_sampleDeclaration = 29;
    static readonly RULE_block = 30;
    static readonly RULE_blockExpression = 31;
    static readonly RULE_qualifiedNameDeclaration = 32;
    static readonly RULE_nameDeclaration = 33;
    static readonly RULE_expression = 34;
    static readonly RULE_literal = 35;
    static readonly RULE_null = 36;
    static readonly RULE_nothing = 37;
    static readonly RULE_void = 38;
    static readonly RULE_number = 39;
    static readonly RULE_string = 40;
    static readonly RULE_string_content = 41;
    static readonly RULE_slot_value = 42;
    static readonly RULE_var = 43;
    static readonly RULE_bool = 44;
    static readonly RULE_annotation = 45;
    static readonly RULE_annotationList = 46;
    static readonly RULE_call = 47;
    static readonly RULE_callArguments = 48;
    static readonly RULE_callArgument = 49;
    static readonly RULE_object = 50;
    static readonly RULE_objectKeyValue = 51;
    static readonly RULE_list = 52;
    static readonly RULE_condition = 53;
    static readonly RULE_otherwise = 54;
    static readonly RULE_correction = 55;
    static readonly RULE_relational = 56;
    static readonly RULE_equality = 57;
...
export declare class Slot_valueContext extends ParserRuleContext {
    SLOT_VALUE_CONTENT(): TerminalNode;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
    enterRule(listener: ACDLParserListener): void;
    exitRule(listener: ACDLParserListener): void;
...
export declare class VarContext extends ParserRuleContext {
    INTERPOLATION_START(): TerminalNode;
    qualifiedName(): QualifiedNameContext;
    INTERPOLATION_END(): TerminalNode;
    PIPE(): TerminalNode | undefined;
    slot_value(): Slot_valueContext | undefined;
    constructor(parent: ParserRuleContext | undefined, invokingState: number);
    get ruleIndex(): number;
    enterRule(listener: ACDLParserListener): void;
    exitRule(listener: ACDLParserListener): void;
