        ...
        (_a = compiledModule.expressions) === null || _a === void 0 ? void 0 : _a.forEach((expr) => {
            ...
            if (expr.kind === "QualifiedNameDeclaration" &&
                ...
                if (templatePath) {
                    ...
                    /*
                     * Given the follwoing file system:
                     * ```
                     ...
                     *
                     * Note: if a develoepr uses the `local` variant of storing templates, their `.npmignore`
                     * configuration should make sure that `src/` is included in the package or else the
                     * `.tgz` output by `npm pack` will not contain the tempaltes and is thus broken.
                     */
