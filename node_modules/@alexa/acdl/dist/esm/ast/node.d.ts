...
export declare type Node = Argument | Annotation | ConditionScope | Correction | When | Expression | EnumItem | Import | ListLiteral | ListItem | Module | Name | SampleScope | Block | TypeParameter | TypeReference | TypeProperty | Utterance | InteractionScope | CorrectionScope | ResponseTemplate | SlotType;
