...
export declare type SerializedArguments = null | string | boolean | number | Serialized<ArgumentValue>[] | {
 ...
 */
export declare type Serialized<T = Node> = T extends Name ? string : T extends NameDeclaration ? {
...
declare type Strip<T, K extends keyof T = never> = Omit<{
