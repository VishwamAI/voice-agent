...
import { Error, LocationObject } from "./error-factory";
import { Type } from "./type";
/**
 * Error encountered while Parsing source code.
 */
export interface ParseError<Code extends Error = Error, Message extends string = string> {
...
export declare type ProjectError = ParseError;
...
export declare function typeError(actual: Type, expected: Type, scope: ask.Node | undefined, errorExpr?: LocationObject): ParseError<Error, string>;
export declare function nameNotFound(name: ask.Name): ParseError<Error, string>;
