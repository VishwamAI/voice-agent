 ...
 */
export declare type LexicalScope = immutable.Map<string, ask.Node[] | ask.Node | undefined>;
export declare function emptyLexicalScope(): LexicalScope;
export declare type ExpressionWithName = Extract<ask.Node, {
    name?: ask.Name;
}>;
/**
