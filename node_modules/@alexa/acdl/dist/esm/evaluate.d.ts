...
import { ConditionalBranch, ConfirmAction, ConfirmArgs, DialogExpansion, End, Ensure, Expect, Expression, InvokeApi, Response } from "./expression";
import { LocationObject } from "./error-factory";
/**
 * An evaluator is a function that takes an expresion and evaluates it to a Thing.
 */
export declare type Evaluator<T> = (expr: T, state: EvaluationState) => EvaluationState;
/**
