...
import { registerDecorator, validate, ValidationError, } from '../..';
export function IsStringOrInstance(classType, options) {
                ...
                validate: function (value, args) {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    if (!(typeof value === 'string' && value.length)) return [3 /*break*/, 1];
                                    return [2 /*return*/, true];
                                case 1:
                                    if (!(typeof value === 'object' && value instanceof args.constraints[0])) return [3 /*break*/, 3];
