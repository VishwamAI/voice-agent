...
export declare type DenormalizePlatformOutputTemplate<PLATFORM_OUTPUT_TEMPLATE extends NormalizedPlatformOutputTemplate> = Omit<OmitIndex<PLATFORM_OUTPUT_TEMPLATE>, 'message' | 'reprompt' | 'nativeResponse'> & {
    [key: string]: unknown;
...
export declare type PlatformOutputTemplate<RESPONSE extends Record<string, unknown> = Record<string, unknown>> = DenormalizePlatformOutputTemplate<NormalizedPlatformOutputTemplate<RESPONSE>>;
