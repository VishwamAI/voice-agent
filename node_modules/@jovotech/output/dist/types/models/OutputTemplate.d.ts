...
export declare type DenormalizeOutputTemplate<OUTPUT_TEMPLATE extends NormalizedOutputTemplate> = Omit<OmitIndex<OUTPUT_TEMPLATE>, 'message' | 'reprompt' | 'platforms'> & {
    [key: string]: unknown;
