...
export declare type PlainObjectType<T> = OmitWhere<T, () => unknown>;
export declare type StateMutatingJovoMethodKey = ArrayElement<typeof STATE_MUTATING_METHOD_KEYS>;
