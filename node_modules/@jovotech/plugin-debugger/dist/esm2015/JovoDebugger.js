...
export class JovoDebuggerPlatform extends CorePlatform {
}
export class JovoDebugger extends Plugin {
    constructor(config) {
        super(config);
    ...
    async initialize(app) {
        ...
        this.socket.on(JovoDebuggerEvent.DebuggerRequest, (requestData) => {
            return this.onReceiveRequest(app, { data: requestData });
        });
        this.socket.on(JovoDebuggerEvent.ServerRequest, (request) => {
    ...
    getStateMutationData(handleRequest, key, jovo, args) {
        var _a;
        let node;
        let handler = BuiltInHandler.Start;
    ...
    async onConnected() {
        var _a, _b;
        const color = (_a = inspect.colors['blue']) !== null && _a !== void 0 ? _a : [0, 0];
        const blueText = (str) => `\u001b[${color[0]}m${str}\u001b[${color[1]}m`;
        const underlineColor = (_b = inspect.colors['underline']) !== null && _b !== void 0 ? _b : [0, 0];
