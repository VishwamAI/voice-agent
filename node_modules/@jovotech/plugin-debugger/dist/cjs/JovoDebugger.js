...
exports.JovoDebugger = exports.JovoDebuggerPlatform = exports.DEFAULT_INCLUDED_PROPERTIES = exports.getDefaultLanguageMap = void 0;
...
exports.DEFAULT_INCLUDED_PROPERTIES = [
    '$request',
    '$id',
    '$input',
    '$history',
...
class JovoDebugger extends framework_1.Plugin {
    ...
    getDefaultConfig() {
        return {
            ...
            includedProperties: exports.DEFAULT_INCLUDED_PROPERTIES,
            plugins: [],
        };
    }
    install(parent) {
