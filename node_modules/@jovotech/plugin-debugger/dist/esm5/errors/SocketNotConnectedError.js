...
var SocketNotConnectedError = /** @class */ (function (_super) {
    __extends(SocketNotConnectedError, _super);
    function SocketNotConnectedError(webhookUrl) {
    ...
    return SocketNotConnectedError;
}(JovoError));
