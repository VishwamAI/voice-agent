...
export class RoutingExecutor {
    ...
    setSkipForRouteMatches(rankedRouteMatches) {
        ...
        const firstRouteMatchIndexWithUnhandled = rankedRouteMatches.findIndex((match) => match.type === BuiltInHandler.Unhandled);
    ...
    async getGlobalRouteMatches() {
        ...
        for (const node of componentNodes) {
            ...
            const relatedHandlerMetadata = MetadataStorage.getInstance().getMergedHandlerMetadataOfComponent(node.metadata.target);
    ...
    compareRouteMatchRanking(match, otherMatch) {
        ...
        const otherMatchIsUnhandled = otherMatch.metadata.intentNames.includes(BuiltInHandler.Unhandled);
