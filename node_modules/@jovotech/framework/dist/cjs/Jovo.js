...
class Jovo {
    ...
    $platform) {
        ...
        this.$id = this.$request.getRequestId ? this.$request.getRequestId() || (0, uuid_1.v4)() : (0, uuid_1.v4)();
    ...
    async $send(outputConstructorOrTemplateOrMessage, options) {
        ...
        if (typeof outputConstructorOrTemplateOrMessage === 'function') {
            const outputInstance = await DependencyInjector_1.DependencyInjector.instantiateClass(this, outputConstructorOrTemplateOrMessage, this, options);
