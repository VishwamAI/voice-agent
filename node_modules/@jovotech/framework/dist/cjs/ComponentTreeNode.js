...
const ComponentNotAvailableError_1 = require("./errors/ComponentNotAvailableError");
...
class ComponentTreeNode {
    ...
    async executeHandler({ jovo, handler = enums_1.BuiltInHandler.Start, callArgs, }) {
        ...
        try {
            ...
            if (this.metadata.options.isAvailable && !this.metadata.options.isAvailable(jovo)) {
                throw new ComponentNotAvailableError_1.ComponentNotAvailableError(this.metadata.target.name);
            }
    ...
    async instantiateComponent(jovo) {
        return await DependencyInjector_1.DependencyInjector.instantiateClass(jovo, this.metadata.target, jovo, this.metadata.options);
    }
    toJSON() {
        var _a;
