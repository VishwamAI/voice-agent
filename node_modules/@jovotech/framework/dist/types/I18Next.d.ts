...
export declare type StringLiteral<T> = T extends string ? (string extends T ? never : T) : never;
export interface I18NextResources extends Resource {
}
export declare type NonIndexedI18NextResources = OmitIndex<I18NextResources>;
export declare type TransformI18NextKeys<KEYS> = Exclude<KEYS, number> extends never ? string : Exclude<KEYS, number>;
export declare type I18NextResourcesLanguageKeys = TransformI18NextKeys<keyof NonIndexedI18NextResources>;
export declare type I18NextResourcesNamespaceKeysOfLanguage<LANGUAGE extends I18NextResourcesLanguageKeys | string> = keyof U.Merge<I18NextResources[LANGUAGE]>;
export declare type I18NextAutoPath<PATH extends string, LANGUAGE extends I18NextResourcesLanguageKeys | string, NAMESPACE extends I18NextResourcesNamespaceKeysOfLanguage<LANGUAGE> | string, MERGED = U.Merge<I18NextResources[LANGUAGE]>> = F.AutoPath<MERGED[A.Cast<NAMESPACE, keyof MERGED>], PATH>;
export declare type I18NextFullPath<PATH extends string, LANGUAGE extends I18NextResourcesLanguageKeys | string, NAMESPACE extends I18NextResourcesNamespaceKeysOfLanguage<LANGUAGE> | string> = S.Join<[LANGUAGE, A.Cast<NAMESPACE, string>, PATH], '.'>;
export declare type I18NextValueAt<PATH extends string, LANGUAGE extends I18NextResourcesLanguageKeys | string, NAMESPACE extends I18NextResourcesNamespaceKeysOfLanguage<LANGUAGE> | string, RESULT = O.Path<NonIndexedI18NextResources, S.Split<I18NextFullPath<PATH, LANGUAGE, NAMESPACE>, '.'>>> = RESULT extends undefined ? string : RESULT;
export interface I18NextConfig extends InitOptions, PluginConfig {
}
export declare type I18NextTFunctionResult = TFunctionResult;
export declare type I18NextTFunctionOptions = TOptionsBase & {
    platform?: string;
};
