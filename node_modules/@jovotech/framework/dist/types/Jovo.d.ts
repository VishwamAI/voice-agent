...
import { BaseComponent, BaseOutput, ComponentConfig, ComponentConstructor, ComponentData, ComponentEvents, DbPluginStoredElementsConfig, I18NextAutoPath, I18NextResourcesLanguageKeys, I18NextResourcesNamespaceKeysOfLanguage, I18NextTFunctionOptions, I18NextTOptions, I18NextValueAt, JovoInput, OutputConstructor, PersistableSessionData, PersistableUserData, Server } from './index';
...
export declare type JovoConstructor<REQUEST extends JovoRequest, RESPONSE extends JovoResponse, JOVO extends Jovo<REQUEST, RESPONSE, JOVO, USER, DEVICE, PLATFORM>, USER extends JovoUser<JOVO>, DEVICE extends JovoDevice<JOVO>, PLATFORM extends Platform<REQUEST, RESPONSE, JOVO, USER, DEVICE, PLATFORM>> = new (app: App, handleRequest: HandleRequest, platform: PLATFORM, ...args: unknown[]) => JOVO;
...
export declare abstract class Jovo<REQUEST extends JovoRequest = JovoRequest, RESPONSE extends JovoResponse = JovoResponse, JOVO extends Jovo<REQUEST, RESPONSE, JOVO, USER, DEVICE, PLATFORM> = any, USER extends JovoUser<JOVO> = JovoUser<JOVO>, DEVICE extends JovoDevice<JOVO> = JovoDevice<JOVO>, PLATFORM extends Platform<REQUEST, RESPONSE, JOVO, USER, DEVICE, PLATFORM> = any> {
    ...
    $delegate<COMPONENT extends BaseComponent>(constructor: ComponentConstructor<COMPONENT>, options: DelegateOptions<ComponentConfig<COMPONENT>, ComponentEvents<COMPONENT>>): Promise<void>;
