...
export declare type IntentMap = Partial<Record<string, string>>;
export declare type JovoConditionFunction = (jovo: Jovo) => boolean | Promise<boolean>;
export declare type JovoAnyFunction = (jovo: Jovo) => Promise<any>;
