 ...
 */
export declare type PlatformTypes<PLATFORM extends Platform> = PLATFORM extends Platform<infer REQUEST, infer RESPONSE, infer JOVO, infer USER, infer DEVICE> ? {
    request: REQUEST;
    response: RESPONSE;
    jovo: JOVO;
    user: USER;
 ...
 */
export declare type PlatformResponseType<PLATFORM extends Platform> = ReturnType<PLATFORM['outputTemplateConverterStrategy']['toResponse']>;
/**
 ...
 */
export declare type TestSuiteResponse<PLATFORM extends Platform> = {
    output: OutputTemplate[];
    response: PlatformResponseType<PLATFORM>;
};
export declare type RequestOrInput<PLATFORM extends Platform> = JovoInput | PlatformTypes<PLATFORM>['request'];
export declare type JovoRequestObject<PLATFORM extends Platform> = OmitWhere<PlatformTypes<PLATFORM>['request'], Function>;
export declare type JovoRequestLike<PLATFORM extends Platform> = PlatformTypes<PLATFORM>['request'] | PlatformTypes<PLATFORM>['request'][] | JovoRequestObject<PLATFORM> | JovoRequestObject<PLATFORM>[];
export declare type JovoInputLike = JovoInput | JovoInput[] | Input | Input[];
export declare type RequestOrInputLike<PLATFORM extends Platform> = JovoRequestLike<PLATFORM> | JovoInputLike;
...
export declare type PartialTestSuiteConfig<PLATFORM extends Platform> = PartialDeep<TestSuiteConfig<PLATFORM>> & Partial<Pick<TestSuiteConfig<PLATFORM>, 'platform'>>;
