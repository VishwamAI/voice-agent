...
export declare type PossibleMiddlewareNames<MIDDLEWARES extends string[]> = PossibleMiddlewareName<ArrayElement<MIDDLEWARES>>;
export declare type PossibleMiddlewareName<NAME extends string> = NAME | `after.${NAME}` | `before.${NAME}`;
