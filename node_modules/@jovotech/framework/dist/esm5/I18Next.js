...
var I18Next = /** @class */ (function (_super) {
    __extends(I18Next, _super);
    function I18Next() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.i18n = i18next;
        return _this;
    }
    I18Next.prototype.getDefaultConfig = function () {
        return {
            interpolation: {
                escapeValue: false,
    ...
    I18Next.prototype.initialize = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.i18n.init(this.config)];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    I18Next.prototype.t = function (path, options) {
        if (options === null || options === void 0 ? void 0 : options.platform) {
            if (Array.isArray(path)) {
                for (var _i = 0, path_1 = path; _i < path_1.length; _i++) {
                    var p = path_1[_i];
                    var platformPath = options.platform + ":translation:" + p;
                ...
                var platformPath = options.platform + ":translation:" + path;
                if (this.i18n.exists(platformPath, options)) {
                    return this.i18n.t(platformPath, options);
                }
            }
