...
var HandlerPlugin = /** @class */ (function (_super) {
    __extends(HandlerPlugin, _super);
    function HandlerPlugin() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    HandlerPlugin.prototype.getDefaultConfig = function () {
        return {};
    };
    HandlerPlugin.prototype.mount = function (parent) {
        var _this = this;
        parent.middlewareCollection.use('dialogue.logic', function (jovo) {
            return _this.handle(jovo);
        });
    };
    HandlerPlugin.prototype.handle = function (jovo) {
        var _a;
        return __awaiter(this, void 0, void 0, function () {
            var componentNode, stackItem, currentStateStackItem;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        componentNode = jovo.$handleRequest.componentTree.getNodeAtOrFail(jovo.$route.resolved.path);
                        ...
                        if (!componentNode.metadata.isGlobal) {
                            ...
                            if (!((_a = jovo.$session.state) === null || _a === void 0 ? void 0 : _a.length)) {
                                ...
                                currentStateStackItem = jovo.$session.state[jovo.$session.state.length - 1];
