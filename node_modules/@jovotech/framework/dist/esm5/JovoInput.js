...
export var DEFAULT_INPUT_TYPE = InputType.Intent;
var JovoInput = /** @class */ (function () {
    function JovoInput(typeOrObject) {
        if (typeOrObject === void 0) { typeOrObject = DEFAULT_INPUT_TYPE; }
    ...
    JovoInput.prototype.getText = function () {
        var _a;
        return this.text || ((_a = this.asr) === null || _a === void 0 ? void 0 : _a.text);
    };
    JovoInput.prototype.getIntentName = function () {
        var _a;
