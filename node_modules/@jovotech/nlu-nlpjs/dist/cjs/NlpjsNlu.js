...
exports.NlpjsNlu = exports.NlpJsEntityType = void 0;
...
})(NlpJsEntityType = exports.NlpJsEntityType || (exports.NlpJsEntityType = {}));
class NlpjsNlu extends framework_1.NluPlugin {
    ...
    async addCorpusFromModelsIn(dir) {
        ...
        for (let i = 0, len = files.length; i < len; i++) {
            ...
            let jovoModelData;
            if (extension === 'js') {
                jovoModelData = require((0, path_1.join)(process.cwd(), filePath));
            }
