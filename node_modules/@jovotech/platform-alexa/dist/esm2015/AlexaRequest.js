...
export const ALEXA_REQUEST_TYPE_TO_INPUT_TYPE_MAP = {
...
export class AlexaRequest extends JovoRequest {
    ...
    getEntityResolutions(slotKey, prefix) {
        ...
        ].filter((authorityResolution) => authorityResolution.status.code === ResolutionPerAuthorityStatusCode.SuccessMatch &&
    ...
    getDeviceCapabilities() {
        ...
        const capabilities = [Capability.Audio];
