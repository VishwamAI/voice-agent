...
export class AlexaOutputTemplateConverterStrategy extends SingleResponseOutputTemplateConverterStrategy {
    constructor() {
        ...
        this.responseClass = AlexaResponse;
    }
    getDefaultConfig() {
    ...
    sanitizeMessage(message, path, maxLength = ALEXA_STRING_MAX_LENGTH, offset = SSML_OFFSET) {
        return super.sanitizeMessage(message, path, maxLength, offset);
    }
    sanitizeDynamicEntities(dynamicEntities, path, maxSize = SLOT_TYPE_VALUES_MAX_SIZE) {
    ...
    toResponse(output) {
        ...
        if (quickReplies && this.config.genericOutputToApl) {
            const directive = (_g = response.response.directives) === null || _g === void 0 ? void 0 : _g.find((directive) => directive.type === 'Alexa.Presentation.APL.RenderDocument');
            if (directive) {
