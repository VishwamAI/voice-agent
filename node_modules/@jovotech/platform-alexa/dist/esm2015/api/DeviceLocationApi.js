...
export async function getDeviceLocation(apiEndpoint, deviceId, permissionToken) {
    const options = {
...
export async function getDeviceAddress(apiEndpoint, deviceId, permissionToken) {
    const options = {
        endpoint: apiEndpoint,
