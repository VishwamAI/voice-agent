...
export function augmentModelPrototypes() {
    ...
    Card.prototype.toApl = function (cardTemplate) {
        var cardJson = cardTemplate || AplCardJson;
        ...
        return __assign({ type: 'Alexa.Presentation.APL.RenderDocument', token: 'token' }, cardJson);
    };
    /* eslint-disable @typescript-eslint/no-explicit-any */
    Carousel.prototype.toApl = function (carouselTemplate) {
        var carouselJson = carouselTemplate || AplCarouselJson;
        if (this.title) {
        ...
        carouselJson.datasources.data.items = this.items.map(function (item) { return (__assign(__assign({}, item), { selection: item.selection
        ...
        return __assign({ type: 'Alexa.Presentation.APL.RenderDocument', token: 'token' }, carouselJson);
    };
