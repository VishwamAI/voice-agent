...
var AplInsertItemOperation = /** @class */ (function (_super) {
    __extends(AplInsertItemOperation, _super);
    function AplInsertItemOperation() {
    ...
    return AplInsertItemOperation;
}(AplOperation));
export { AplInsertItemOperation };
