...
import { IsArray, IsEitherValid, IsNotEmpty, IsOptional, IsString, IsStringOrInstance, Type, } from '@jovotech/output';
import { AplParameter } from './AplParameter';
var AplLayout = /** @class */ (function () {
    function AplLayout() {
    }
    __decorate([
        IsOptional(),
    ...
    __decorate([
        ...
        Type(function () { return AplParameter; }),
        __metadata("design:type", Array)
