...
var AplDeleteItemsOperation = /** @class */ (function (_super) {
    __extends(AplDeleteItemsOperation, _super);
    function AplDeleteItemsOperation() {
    ...
    return AplDeleteItemsOperation;
}(AplOperation));
export { AplDeleteItemsOperation };
