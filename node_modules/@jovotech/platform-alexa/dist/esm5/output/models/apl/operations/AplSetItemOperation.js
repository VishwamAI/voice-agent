...
var AplSetItemOperation = /** @class */ (function (_super) {
    __extends(AplSetItemOperation, _super);
    function AplSetItemOperation() {
    ...
    return AplSetItemOperation;
}(AplOperation));
export { AplSetItemOperation };
