...
var VideoAppLaunchDirective = /** @class */ (function (_super) {
    __extends(VideoAppLaunchDirective, _super);
    function VideoAppLaunchDirective() {
    ...
    __decorate([
        ValidateNested(),
        Type(function () { return VideoItem; }),
        __metadata("design:type", VideoItem)
    ], VideoAppLaunchDirective.prototype, "videoItem", void 0);
    return VideoAppLaunchDirective;
}(Directive));
export { VideoAppLaunchDirective };
