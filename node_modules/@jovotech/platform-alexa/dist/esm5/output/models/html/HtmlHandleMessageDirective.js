...
var HtmlHandleMessageDirective = /** @class */ (function (_super) {
    __extends(HtmlHandleMessageDirective, _super);
    function HtmlHandleMessageDirective() {
    ...
    return HtmlHandleMessageDirective;
}(Directive));
export { HtmlHandleMessageDirective };
