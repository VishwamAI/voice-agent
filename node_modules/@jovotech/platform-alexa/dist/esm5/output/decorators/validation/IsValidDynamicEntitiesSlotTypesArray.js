...
import { DynamicEntitiesUpdateBehavior, } from '../../models/dialog/DialogUpdateDynamicEntitiesDirective';
export function IsValidDynamicEntitiesSlotTypesArray(options) {
                ...
                validate: function (value, args) {
                    return __awaiter(this, void 0, void 0, function () {
                        ...
                        return __generator(this, function (_a) {
                            switch (_a.label) {
                                case 0:
                                    behavior = args.object.updateBehavior;
                                    if (!(behavior === DynamicEntitiesUpdateBehavior.Replace)) return [3 /*break*/, 2];
