...
import { IsEitherValid, isString, isURL } from '@jovotech/output';
import { CARD_IMAGE_URL_MAX_LENGTH } from '../../constants';
export function IsValidCardImageUrl(options) {
    var _this = this;
        ...
        validate: function (value) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                if (!isString(value) || !isURL(value, { protocols: ['https'] })) {
                    return [2 /*return*/, '$property must be an URL address'];
                }
                if (value.length > CARD_IMAGE_URL_MAX_LENGTH) {
                    return [2 /*return*/, "$property can not exceed " + CARD_IMAGE_URL_MAX_LENGTH + " characters."];
                }
                return [2 /*return*/];
            });
        }); },
