...
export var COUNTRY_AND_POSTAL_CODE = 'address/countryAndPostalCode';
export function getDeviceLocation(apiEndpoint, deviceId, permissionToken) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_1 = _a.sent();
                    handleDeviceLocationApiErrors(error_1);
                    return [3 /*break*/, 4];
...
export function getDeviceAddress(apiEndpoint, deviceId, permissionToken) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    error_2 = _a.sent();
                    handleDeviceLocationApiErrors(error_2);
                    return [3 /*break*/, 4];
                case 4: throw new Error('Unexpected error.');
            }
        });
...
export function handleDeviceLocationApiErrors(error) {
    var _a, _b;
