...
import { sendApiRequest } from './AlexaApi';
export function getProductList(apiEndpoint, permissionToken, language, params) {
    return __awaiter(this, void 0, void 0, function () {
        var options, response, error_1, message;
            ...
            switch (_a.label) {
                ...
                case 3:
                    ...
                    if (error_1.isAxiosError) {
                        ...
                        throw new JovoError({ message: message });
                    }
