...
import { axios, JovoError, } from '@jovotech/framework';
import { URL } from 'url';
export var AlexaApiErrorCode;
...
})(AlexaApiErrorCode || (AlexaApiErrorCode = {}));
var AlexaApiError = /** @class */ (function (_super) {
    __extends(AlexaApiError, _super);
    function AlexaApiError(options) {
        var _this = _super.call(this, __assign(__assign({}, options), { message: "Request to Alexa API failed: " + options.message })) || this;
        _this.code = options.code;
        return _this;
    }
    return AlexaApiError;
}(JovoError));
export { AlexaApiError };
/**
...
export function sendApiRequest(options) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    url = new URL(options.path, options.endpoint);
                    config = {
                        url: url.href,
                        data: options.data,
                        method: options.method || 'GET',
                        headers: __assign({ 'Content-Type': 'application/json', 'Authorization': "Bearer " + options.permissionToken }, options.headers),
