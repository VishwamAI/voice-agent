...
class BuildHook extends AlexaHook_1.AlexaHook {
    ...
    checkLocales(projectFiles) {
        ...
        const privacyAndCompliances = (0, lodash_get_1.default)(projectFiles, `skill-package/["skill.json"].manifest.privacyAndCompliance.locales`, {});
        const publishingInfos = (0, lodash_get_1.default)(projectFiles, `skill-package/["skill.json"].manifest.publishingInformation.locales`, {});
        ...
        (0, lodash_set_1.default)(projectFiles, 'skill-package/["skill.json"].manifest.publishingInformation.locales', publishingInfos);
        (0, lodash_set_1.default)(projectFiles, 'skill-package/["skill.json"].manifest.privacyAndCompliance.locales', privacyAndCompliances);
    }
    mergeGenericLocale(fileObject, locale, genericLocale) {
        if (genericLocale && fileObject[genericLocale]) {
            fileObject[locale] = (0, lodash_merge_1.default)({}, fileObject[genericLocale], fileObject[locale]);
        }
    }
