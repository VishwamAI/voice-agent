import { JovoCliPlugin, PluginCommand, PluginHook, PluginType, RequiredOnlyWhere } from '@jovotech/cli-core';
import { AlexaCliConfig } from './interfaces';
export declare type AlexaCliInitConfig = RequiredOnlyWhere<AlexaCliConfig, 'conversations.enabled'> | {
