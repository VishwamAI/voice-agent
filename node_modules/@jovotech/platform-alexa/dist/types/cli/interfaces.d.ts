...
export declare type SupportedLocalesType = (typeof SupportedLocales)[number];
...
export declare type SkillStatus = 'SUCCEEDED' | 'FAILED' | 'IN_PROGRESS';
...
export declare enum PublicationMethod {
    MANUAL_PUBLISHING = "MANUAL_PUBLISHING",
    AUTO_PUBLISHING = "AUTO_PUBLISHING"
}
export declare type PublicationMethodLike = EnumLike<PublicationMethod> | string;
export declare type ValidationStatus = 'SUCCEEDED' | 'FAILED' | 'IN_PROGRESS';
