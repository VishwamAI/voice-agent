...
export declare type PermissionScopeLike = EnumLike<PermissionScope> | string;
...
export declare type ConnectionPermissionScopeLike = EnumLike<ConnectionPermissionScope> | string;
