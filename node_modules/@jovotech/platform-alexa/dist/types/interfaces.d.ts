...
export declare type PlayerActivity = 'PLAYING' | 'PAUSED' | 'FINISHED' | 'BUFFER_UNDERRUN' | 'IDLE';
...
export declare type PermissionStatus = 'DENIED' | 'ACCEPTED' | 'NOT_ANSWERED';
...
export declare type PurchaseResultLike = EnumLike<PurchaseResult> | string;
...
export declare type ConversationsTarget = 'AMAZON.Conversations' | 'skill';
