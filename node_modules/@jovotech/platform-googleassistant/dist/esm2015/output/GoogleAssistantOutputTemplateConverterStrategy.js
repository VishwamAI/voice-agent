...
export class GoogleAssistantOutputTemplateConverterStrategy extends SingleResponseOutputTemplateConverterStrategy {
    constructor() {
        ...
        this.responseClass = GoogleAssistantResponse;
    }
    ...
    sanitizeQuickReplies(quickReplies, path, maxSize = SUGGESTIONS_MAX_SIZE, maxLength = SUGGESTION_TITLE_MAX_LENGTH) {
        return super.sanitizeQuickReplies(quickReplies, path, maxSize, maxLength);
    }
    sanitizeCarousel(carousel, path, minSize = COLLECTION_MIN_SIZE, maxSize = COLLECTION_MAX_SIZE) {
    ...
    toResponse(output) {
        ...
        if (listen === false) {
            ...
            const typeOverrideMode = listen.entities.mode === DynamicEntitiesMode.Merge
    ...
    fromResponse(response) {
        ...
        if ((_h = (_g = response.session) === null || _g === void 0 ? void 0 : _g.typeOverrides) === null || _h === void 0 ? void 0 : _h.length) {
            ...
            const mode = response.session.typeOverrides[0].typeOverrideMode === TypeOverrideMode.Merge
    ...
    convertDynamicEntityToTypeOverride(entityName, entity, mode = TypeOverrideMode.Replace) {
        return {
            name: entityName,
