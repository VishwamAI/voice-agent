...
export declare type GoogleAssistantCapabilityType = CapabilityType | GoogleAssistantCapability | `${GoogleAssistantCapability}` | NativeCapability | `${NativeCapability}`;
