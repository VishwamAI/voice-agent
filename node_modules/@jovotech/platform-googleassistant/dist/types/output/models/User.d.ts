...
export declare type AccountLinkingStatusLike = EnumLike<AccountLinkingStatus>;
export declare enum UserVerificationStatus {
    Unspecified = "USER_VERIFICATION_STATUS_UNSPECIFIED",
    Guest = "GUEST",
    Verified = "VERIFIED"
}
export declare type UserVerificationStatusLike = EnumLike<UserVerificationStatus>;
...
export declare type SkuTypeLike = EnumLike<SkuType>;
