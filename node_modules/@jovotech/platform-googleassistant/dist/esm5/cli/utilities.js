...
export function checkForGactionsCli() {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    _a.trys.push([0, 2, , 3]);
                    return [4 /*yield*/, execAsync('gactions version')];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
...
export function getGactionsError(errorMessage) {
    ...
    var errorToken = 'Server did not return HTTP 200.';
    if (errorMessage.includes(errorToken)) {
        var error = JSON.parse(errorMessage.substring(errorMessage.indexOf(errorToken) + errorToken.length)).error;
        return new JovoCliError({
