...
var GoogleAssistantResponse = /** @class */ (function (_super) {
    __extends(GoogleAssistantResponse, _super);
    function GoogleAssistantResponse() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    GoogleAssistantResponse.prototype.hasSessionEnded = function () {
        var _a, _b;
        return ((_b = (_a = this.scene) === null || _a === void 0 ? void 0 : _a.next) === null || _b === void 0 ? void 0 : _b.name) === 'actions.scene.END_CONVERSATION';
    };
    GoogleAssistantResponse.prototype.getSpeech = function () {
    ...
    GoogleAssistantResponse.prototype.getReprompt = function () {
    ...
    GoogleAssistantResponse.prototype.replaceSpeech = function (speech) {
        var _a, _b;
        // Usually, Google Assistant Jovo responses only contain firstSimple,
    ...
    __decorate([
        IsOptional(),
        ValidateNested(),
        Type(function () { return Scene; }),
        __metadata("design:type", Scene)
    ], GoogleAssistantResponse.prototype, "scene", void 0);
    __decorate([
        IsOptional(),
        ValidateNested(),
        Type(function () { return Session; }),
