...
var GoogleAssistantRequestBuilder = /** @class */ (function (_super) {
    __extends(GoogleAssistantRequestBuilder, _super);
    function GoogleAssistantRequestBuilder() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    GoogleAssistantRequestBuilder.prototype.launch = function (json) {
        // eslint-disable-next-line @typescript-eslint/no-var-requires
        var launchJson = require(joinPaths(__dirname, '..', '..', 'sample-requests', 'LaunchRequest.json'));
        var request = Object.create(GoogleAssistantRequest.prototype);
        return Object.assign(request, json || launchJson);
    };
    GoogleAssistantRequestBuilder.prototype.intent = function (nameOrJson) {
        // eslint-disable-next-line @typescript-eslint/no-var-requires
    ...
    return GoogleAssistantRequestBuilder;
}(RequestBuilder));
export { GoogleAssistantRequestBuilder };
