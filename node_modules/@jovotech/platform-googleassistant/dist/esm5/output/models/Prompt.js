...
var Simple = /** @class */ (function () {
    ...
    Simple.prototype.toMessage = function () {
        var message = {};
        if (this.text) {
...
var Prompt = /** @class */ (function () {
    ...
    __decorate([
        ...
        Type(function () { return Suggestion; }),
        __metadata("design:type", Array)
