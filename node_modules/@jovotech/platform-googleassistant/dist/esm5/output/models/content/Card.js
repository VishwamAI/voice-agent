...
import { formatValidationErrors, IsEnum, IsNotEmpty, IsOptional, IsSomeValid, isString, IsString, Type, validate, ValidateNested, } from '@jovotech/output';
import { Image, ImageFill } from '../common/Image';
import { Link } from '../common/Link';
var Card = /** @class */ (function () {
    function Card() {
    }
    Card.prototype.toCard = function () {
        var _a;
        var card = {
                    ...
                    switch (_a.label) {
                        case 0:
                            if (!(value instanceof Image)) {
                                return [2 /*return*/, "$property has to be an instance of Image"];
                            }
